...
class ResourceModel(BaseModel):
    ...
    RdsHost: Optional[str]
    RdsUser: Optional[str]
    RdsPassword: Optional[str]
    ...
    def _deserialize(
        ...
        return cls(
            ...
            RdsHost=json_data.get("RdsHost"),
            RdsUser=json_data.get("RdsUser"),
            RdsPassword=json_data.get("RdsPassword"),
        )
